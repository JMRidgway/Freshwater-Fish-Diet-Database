...
temp <- data_fish %>% 
  ...
  mutate(prey_class = case_when(prey_class == "Actinopteri" ~ "Actinopterygii",
                                ...
                                prey_taxon %in% c("limnaea", "neritidae") ~ "Gastropoda",
         ...
         prey_kingdom = case_when(prey_family == "Microcystaceae" ~ "Bacteria",
                                  prey_taxon %in% c("Unknown Fish", "helminth", "Calanoida", "dugesia_sp",
                                                    "Leptoceridae","adults_copepodites",
                                                    "myriapodes","macrothrix_laticornis","limnaea") ~ "Animalia",
         ...
         prey_phylum = case_when(prey_phylum == "Ocrophyta" ~ "Ochrophyta",
                                 ...
                                 prey_taxon %in% c("Leptocerida", "opossum shrimp", 
                                                   "myriapodes","adults_copepodites","macrothrix_laticornis") ~ "Arthropoda",
                                 ...
                                 prey_taxon %in% c("bythinidae", "neritidae","limnaea") ~ "Mollusca",
         ...
         prey_subphylum = case_when(grepl("crab", prey_taxon) ~ "Crustacea",
                                    ...
                                    prey_taxon == "myriapodes" ~ "Myriapoda",
